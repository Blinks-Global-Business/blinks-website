export const DIAGNOSTIC_OFFER = {
  title: "Diagnostic Stratégique & Digital",
  price: "19 900",
  currency: "FCFA",
  equivalent: "≈ 30 € / 33 $",
...
export const PARCOURS = [
  {
    ...
    price: "149 000",
    period: "/ mois",
    engagement: "Engagement 3 mois · prix de lancement",
    recommended: false,
    features: [
  ...
  },
  {
    ...
    recommended: true,
    features: [
      "Tout le contenu du Parcours Visibilité",
      "OFFERT : création ou refonte de votre logo + charte graphique (valeur 250 000 F)",
      "OFFERT : site internet professionnel avec chatbot IA intégré (valeur 450 000 F)",
    ...
    note: "Le branding est livré au mois 1, le site avec chatbot au mois 2 pour construire sur des fondations solides.",
  },
  {
    id: "excellence",
    ...
    recommended: false,
    features: [
      "Tout le contenu du Parcours Croissance",
...
export const A_LA_CARTE = [
  {
    ...
    price: "dès 297 000 FCFA",
    description: "Site vitrine, institutionnel ou e-commerce sur mesure. Design + développement, optimisé conversion, mobile-first, hébergement clé en main. Livré en 14 jours.",
  },
  {
    name: "Application, CRM & ERP",
    price: "dès 690 000 FCFA",
    description: "Applications web et mobiles, CRM, ERP, portails, intranets et chatbots IA développés sur mesure. Maintenance incluse 30 jours.",
  },
  {
    name: "Identité visuelle & logo",
    price: "dès 147 000 FCFA",
    description: "Logo principal + variantes, charte graphique complète, déclinaisons réseaux sociaux et papeterie. Livré en 7 jours, 2 rounds de modifications inclus.",
  },
  {
    name: "Production vidéo",
    price: "dès 190 000 FCFA",
    description: "Vidéos, clips, spots publicitaires et institutionnels de qualité professionnelle. Fichiers sources inclus, à vous, à vie.",
  },
  {
    name: "Supports imprimés & objets publicitaires",
    price: "dès 90 000 FCFA",
    description: "Affiches, flyers, brochures, kakémonos, PLV, goodies et signalétique alignés sur votre identité visuelle.",
  },
  {
    name: "Campagne publicitaire ponctuelle",
    price: "dès 147 000 FCFA",
    description: "Campagne Meta Ads ou Google Ads clé en main : ciblage, créations, pilotage et rapport de résultats. Budget publicitaire non inclus.",
  },
];
